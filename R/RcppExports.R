...
residualize <- function(X, grid_points, tree_l0, tree_r0, levels, post_states0, Is_non_terminal, children_IDs, c_learn) {
    .Call(`_SMCMP_residualize`, X, grid_points, tree_l0, tree_r0, levels, post_states0, Is_non_terminal, children_IDs, c_learn)
}

G_inverse <- function(Y, tree_l, tree_r, theta_post, children_IDs) {
    .Call(`_SMCMP_G_inverse`, Y, tree_l, tree_r, theta_post, children_IDs)
}
